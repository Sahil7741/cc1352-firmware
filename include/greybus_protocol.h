...
#define GB_SVC_TYPE_INTF_DEVICE_ID_RESPONSE                                    \
  OP_RESPONSE | GB_SVC_TYPE_INTF_DEVICE_ID_REQUEST
#define GB_SVC_TYPE_CONN_CREATE_REQUEST 0x07
#define GB_SVC_TYPE_CONN_CREATE_RESPONSE                                       \
  OP_RESPONSE | GB_SVC_TYPE_CONN_CREATE_REQUEST
#define GB_SVC_TYPE_CONN_DESTROY_REQUEST 0x08
#define GB_SVC_TYPE_CONN_DESTROY_RESPONSE                                      \
  OP_RESPONSE | GB_SVC_TYPE_CONN_DESTROY_REQUEST
#define GB_SVC_TYPE_DME_PEER_GET_REQUEST 0x09
#define GB_SVC_TYPE_DME_PEER_GET_RESPONSE                                      \
  OP_RESPONSE | GB_SVC_TYPE_DME_PEER_GET_REQUEST
#define GB_SVC_TYPE_DME_PEER_SET_REQUEST 0x0a
#define GB_SVC_TYPE_DME_PEER_SET_RESPONSE                                      \
  OP_RESPONSE | GB_SVC_TYPE_DME_PEER_SET_REQUEST
...
#define GB_SVC_TYPE_ROUTE_DESTROY_RESPONSE                                     \
  OP_RESPONSE | GB_SVC_TYPE_ROUTE_DESTROY_REQUEST
...
#define GB_SVC_TYPE_INTF_VSYS_ENABLE_RESPONSE                                  \
  OP_RESPONSE | GB_SVC_TYPE_INTF_VSYS_ENABLE_REQUEST
...
#define GB_SVC_TYPE_INTF_ACTIVATE_RESPONSE                                     \
  OP_RESPONSE | GB_SVC_TYPE_INTF_ACTIVATE_REQUEST
